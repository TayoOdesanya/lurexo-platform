    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl border border-slate-700/50 shadow-2xl max-w-md w-full p-6">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-lg font-semibold text-emerald-400 px-4 py-2 bg-emerald-500/10 rounded-lg border border-emerald-500/20">
            {organizerName}
          </p>
          <p className="text-sm text-slate-400 mt-4">
            Once verified, this organizer will be able to create and publish events. They will receive a verification email.
          </p>
        </div>
