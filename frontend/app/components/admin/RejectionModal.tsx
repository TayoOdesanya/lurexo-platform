...
export default function RejectionModal({ eventTitle, onConfirm, onCancel }: RejectionModalProps) {
        ...
        {selectedReason && (
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder="Provide more context about why this event is being rejected..."
              rows={4}
